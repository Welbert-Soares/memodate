    ...
    >
      <div className="max-w-lg mx-auto flex items-center justify-around h-14">
        ...
        <Link
          ...
          className={`flex items-center justify-center w-20 h-full transition-colors ${isNew ? 'text-indigo-700 dark:text-indigo-400' : 'text-indigo-500 dark:text-indigo-400'}`}
        >
